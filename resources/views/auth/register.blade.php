...
<html lang="en">
    ...
    <head>
        ...
        <meta content="UsedBookr Admin" name="description" />
        <meta content="UsedBookr" name="author" />
        <!-- App favicon -->
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="#" class="auth-logo">
                                    <img src="{{ asset('backend/assets/images/logo-dark.png') }}" height="" class="logo-dark mx-auto" alt="">
